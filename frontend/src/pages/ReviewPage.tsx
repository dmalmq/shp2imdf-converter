...
export function ReviewPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-4xl flex-col gap-4 p-6">
      <h1 className="text-3xl font-semibold">Review (Phase 1 Shell)</h1>
      <p className="text-slate-600">
        Map/table review and editing are introduced in Phase 4. This placeholder confirms routing flow.
      </p>
